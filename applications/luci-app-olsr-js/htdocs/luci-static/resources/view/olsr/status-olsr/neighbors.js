...
return view.extend({
  ...
  fetch_jsoninfo: function (otable) {
    ...
    var jsonreq6 = "";
    var v4_port =
      parseInt(uci.get("olsrd", "olsrd_jsoninfo", "port") || "") || 9090;
    var v6_port =
      parseInt(uci.get("olsrd6", "olsrd_jsoninfo", "port") || "") || 9090;
    var json;
    var self = this;
...
devices.forEach(function(dev) {
  ...
  render: function () {
			...
			return	this.action_neigh().then(function(result) {
				...
				var table = E(
					"div",
					{ class: "table cbi-section-table", id: "olsr_neigh_table" },
					[
    ...
    for (var k = 0; k < links.length; k++) {
      ...
      var tr = E(
        ...
        {
          class:
            "tr cbi-section-table-row cbi-rowstyle-" +
            i +
            " proto-" +
            link.proto,
        },
        [
            ...
            ? E(
                ...
                [
                  E(
                    ...
                    {
                      href:
                        "http://[" + link.remoteIP + "]/cgi-bin-status.html",
                    },
                    link.remoteIP
                  ),
                ]
          ...
          E(
            ...
            [
              E(
                "a",
                { href: "http://" + link.hostname + "/cgi-bin-status.html" },
                link.hostname
              ),
            ]
          ),
